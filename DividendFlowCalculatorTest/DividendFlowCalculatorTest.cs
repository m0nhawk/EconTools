...
namespace GivenAData
{
	...
	public class OnCalculation
	{
		...
		Tuple<Matrix<double>, int> dynamicDividend;
		...
		public void Init ()
		{
			...
			dynamicDividend = System.Tuple.Create (Matrix<double>.Build.DenseOfArray(new double[,] {
		...
		public void CorrectDynamicDidivend ()
		{
			...
			Assert.That (dynamicDividendResult.Item1, Is.EqualTo (dynamicDividend.Item1).Using (new MatrixWithinComparer ()));
			Assert.AreEqual (dynamicDividendResult.Item2, dynamicDividend.Item2);
		}
